...
The following custom function trims adapters hierarchically from the longest to
...
Dai ele nao bufou durante a minha parte.. (ele começa a bufar quando está irritado, ou nervoso 
com algo...)
Mas depois da reunião fui na sala dele falar sobre o meu visto e a minha data de início.
O pessoal do RH de Berkeley tinha me orientado a esperar para comunicar a minha saída
até o momento que eu tivesse tudo certo. A guria que cuida do meu caso me escreveu hoje 
dizendo que ainda faltam etapas, que ela precisa o documento físico dizendo que meu
visto foi aprovado. Mas aparentemente, são processos internos e só papelada...

então resolvi falar para ele. Aí ele bufou! E muito!
Disse que era para eu contactar o Lab e falar que eu era obrigada a terminar o meu
contrato aqui. Me disse tbm que se fosse ao contrário e alguém pedisse isso para ele, 
ele ia ver isso com bons olhos e ia ser um sinal que a pessoa é responsável (falou isso tentando me 
manipular neh!)
